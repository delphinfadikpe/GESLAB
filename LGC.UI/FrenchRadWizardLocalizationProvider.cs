...
//using Telerik.WinControls.UI.TreeView.LocalizationProvider;
...
namespace LGC.UI
{
    ...
    public class RadWizardLocalization : RadWizardLocalizationProvider
    {

        public override string GetLocalizedString(string id)
        {

            return RadLocalizationGeneric.GetRadWizardLocalizedString(id) ?? base.GetLocalizedString(id);
        }
    }
    ...
    internal static class RadLocalizationGeneric
    {
            ...
            switch (System.Globalization.CultureInfo.CurrentCulture.LCID)
            {
                case 1036:
                    ...
                    switch (id)
                    {
                        ...
                        case RadGridStringId.FilterOperatorEqualTo: return "Est égal à";
                        case RadGridStringId.FilterOperatorGreaterThan: return "Est supérieur à";
                        case RadGridStringId.FilterOperatorGreaterThanOrEqualTo: return "Est supérieur ou égal à";
                        case RadGridStringId.FilterOperatorIsEmpty: return "Est vide";
                        case RadGridStringId.FilterOperatorIsNull: return "Est nul";
                        case RadGridStringId.FilterOperatorLessThan: return "Est inférieur à";
                        case RadGridStringId.FilterOperatorLessThanOrEqualTo: return "Est inférieur ou égal à";
                        case RadGridStringId.FilterOperatorNoFilter: return "Pas de filtre";
                        case RadGridStringId.FilterOperatorNotBetween: return "Non compris entre";
                        case RadGridStringId.FilterOperatorNotEqualTo: return "Est différent de";
                        case RadGridStringId.FilterOperatorNotIsEmpty: return "Est non vide";
                        case RadGridStringId.FilterOperatorNotIsNull: return "Est non nul";
                        ...
                        case RadGridStringId.FilterOperatorCustom: return "Filtre personnalisé";
        ...
        internal static string GetRadWizardLocalizedString(string id)
        {
            switch (System.Globalization.CultureInfo.CurrentCulture.LCID)
            {
                case 1036:
                    ...
                    switch (id)
                    {
                        case RadWizardStringId.BackButtonText: return "Précédent";
                        case RadWizardStringId.CancelButtonText: return "Annuler";
                        case RadWizardStringId.FinishButtonText: return "Terminer";
                        case RadWizardStringId.HelpButtonText: return "Aide";
                        case RadWizardStringId.NextButtonText: return "Suivant";
